...
[![npm version](https://img.shields.io/npm/v/react-native-picker.svg?style=flat-square)](https://www.npmjs.com/package/react-native-picker) <a href="https://david-dm.org/hossein92/hy-react-native-picker"><img src="https://david-dm.org/hossein92/hy-react-native-picker.svg?style=flat-square" alt="dependency status"></a>   
...
```javascript
	npm install hy-react-native-picker --save
```
...
```javascript
import Picker from 'hy-react-native-picker';
let data = [];
for(var i=0;i<100;i++){
    data.push(i);
}
...
target 'YourTarget' do
    ...
    pod 'Picker', :path => '../YOUR_REACT_NATIVE_PROJECT/node_modules/hy-react-native-picker'
end
```
After you have updated the `Podfile` of the existing app, you can install `hy-react-native-picker` like below:
``` bash
$ pod install
```
...
### For pure javascript version -> [v3.0.5](https://github.com/hossein92/react-native-picker/tree/pure-javascript-version)  
